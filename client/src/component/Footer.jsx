...
const Footer = () => {
  return (
     <footer className="relative px-6 pt-8 md:px-16 lg:px-36 w-full text-gray-300">
              <Blurcircle top='0%' right='0%'/>
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-10">
                <div className="md:max-w-96">
                    <div className=' px-2 py-2 rounded-full flex flex-row space-x-3'>
                 
            <TvMinimalPlay  />
            <span className='text-1xl font-semibold'>CINEVERSE</span>
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>90789000</p>
                            <p>contact@cineverse.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © <a href="https://prebuiltui.com">CINEVERSE</a>. All Right Reserved.
            </p>
        </footer>
  )
}
